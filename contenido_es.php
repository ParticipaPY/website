...
$paper_3 = array(
	 	 "texto" => "Tanja Aitamurto, Jorge Saldivar. Examining the Quality of Crowdsourced Deliberation: Respect, Reciprocity and Lack of Common-Good Orientation. CHI’17 Extended Abstracts, 6 al 11 de Mayo de 2017, Denver, CO, USA.",
...
$paper_6 = array(
		"texto" => "Cristhian Parra, Christelle Rohaut, Marianne Maeckelbergh, Valerie Issarny, James Holston. Expanding the Design Space of ICT for Participatory Budgeting. Communities and Technologies 2017, Jun 2017, Troyes, Francia. ACM, Communities and Technologies 2017, 2017.",
...
$reporte_1 = array(
		"texto" => "Jorge Saldivar, Cristhian Parra, Marcelo Alcaraz, Rebeca Arteta, LucaCernuzzi. Estudio de la literatura: Tecnologías utilizadas para promover la participación ciudadana en la innovación del sector público. Reporte Técnico D1 - Proyecto Participa. 2016",
...
$miembro_8 = array(
		...
		"cargo" => "(UC, Paraguay)<br>Ingeniero Junior",
		"descripcion" => ""
	);

$miembro_9 = array(
		"nombre" => "Ing. Jammily Ortigoza<br>",
		"cargo" => "(UC, Paraguay)<br>Ingeniera Junior",
		"descripcion" => ""
	);

$miembro_10 = array(
		"nombre" => "Gustavo Vera Scuderi<br>",
		"cargo" => "(Codium S.A., Paraguay)<br>Front-End Developer - Colaborador Externo",
		"descripcion" => ""
	);
